...
// The arguments by default are required
// To have optional arguments you use [] and should assign a value to the argument
void greet (String name, [String message = 'Hello']) {
  print('$message $name');
}

// If you want the order of the arguments would be any, you should use {}
// If you want to have optional values you should assign a value to the argument
